...
export INSTRUMENT_BIN=/FuzzingTools/Legion/bin/
export LEGION_PATH=/FuzzingTools/Legion
...
usage(){
	...
	echo "[LEGION]USAGE: INSTRUMENT.sh build -zip|-gz <file> [--call-graph] or INSTRUMENT.sh run <seed folder> <output path> [-d]"
}
